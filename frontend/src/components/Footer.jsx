        ...
        <div className="px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-4 md:mb-0">
              © 2025 AI Code Review Assistant. All rights reserved.
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">AI Code Review Assistant</h3>
            <p className="text-gray-400 mb-4">
              Transform your development workflow with automated code quality checks,
              security analysis, and intelligent suggestions.
            </p>
